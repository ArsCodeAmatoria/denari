...
function SolarSystemScene() {
  useEffect(() => {
    console.log("SolarSystemScene mounted");
    return () => {
      console.log("SolarSystemScene unmounted");
    };
  }, []);
...
export function SolarSystem() {
  useEffect(() => {
    ...
    return () => {
      console.log("SolarSystem component unmounted");
    };
  }, []);
    ...
    <div className="h-full w-full relative" style={{ minHeight: '400px' }}>
      <div className="absolute inset-0 rounded-xl overflow-hidden">
        <Canvas
          ...
          fallback={<div className="w-full h-full flex items-center justify-center text-primary">Loading 3D Scene...</div>}
        >
          <SolarSystemScene />
        </Canvas>
      </div>
